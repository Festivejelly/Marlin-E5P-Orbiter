...
#define STRING_CONFIG_H_AUTHOR "(NickJ, SKR 2 Creality Ender-5 Plus)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 680 }
...
#define NOZZLE_TO_PROBE_OFFSET { -44, -7, -3.0 }
